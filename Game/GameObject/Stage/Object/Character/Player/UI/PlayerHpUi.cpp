...
PlayerHpUi::PlayerHpUi()
{
	...
	m_constBuffer->SetParameter(static_cast<unsigned int>(ConstBufferOffset::INCLINATION_OFFSET), 0.0f);
	...
	m_constBuffer->SetParameter(static_cast<unsigned int>(ConstBufferOffset::SIZE_OFFSET), DirectX::XMFLOAT2(0.4f, 0.025f));
	m_constBuffer->SetParameter(static_cast<unsigned int>(ConstBufferOffset::POSITION_OFFSET), DirectX::XMFLOAT2(0.05f, 1.9f));
	m_constBuffer->SetParameter(static_cast<unsigned int>(ConstBufferOffset::ALPHA_OFFSET), 0.8f);
